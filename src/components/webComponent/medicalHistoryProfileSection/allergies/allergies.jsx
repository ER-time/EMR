...
export default function Allergies() {
  ...
  return (
    <>
      <Box  width="100%" display="flex" justifyContent={ allergiesData?.data?.data?.length > 0 ? "flex-end" : "center"}>
        <Button

          variant="contained"
          height="45px"
          radius="12px"
          sx={{ margin: "15px",backgroundColor: "#E02828"}}
          startIcon={<AddIcon />}
          onClick={() => {
            setOpen(true)
            setRowData(null)
      ...
      {deleteModal && (
        <DeleteModal
          ...
          tittle="Delete Allergies History"
