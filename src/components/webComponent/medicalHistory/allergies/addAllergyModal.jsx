...
const AddAllergyModal = ({
  ...
  const [addOrUpdateAllergies,{data:AllergiesData,isLoading:AllergiesDataLaoding}]=useAllergiesAddOrUpdateMutation()
            ...
            <Grid container spacing={3}>
              <Grid item xs={12} md={4}>
                <Box width="100%">
                  ...
                  >
                    {allergiesTypes?.data?.data?.map((allergyItem, index) => (
