...
import PsychiatristChatRoomHistory from "./psychiatristChatRoomHistory";
...
export default function PsychiatristChatRoom({ showMessanger }) {
  ...
  const [getRandomSessionId, { data, isLoading }] =
    useGetRandomSessionIdMutation();
  let [specificChatHistory, setSpecificChatHistory] = useState("");
  useEffect(() => {
    if (userID || sessionIDTrigger) getRandomSessionId();
